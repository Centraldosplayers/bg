const player = {
      ...
      spectrumAnalyser(){
            ...
            function drawSpectrum(bufferLength, x, barWidth, barHeight, dataArray){
                  ...
                  grad.addColorStop(0, "#0ec508");
                  grad.addColorStop(0.55, "#ffcc00");
                  grad.addColorStop(1, "#d90000");
                  for(var i = 0; i < bufferLength; i++){
                        barHeight = dataArray[i]/3.6;
                        ctx.fillStyle = "white";
      ...
      async getNews(){
            const url = `https://newsapi.org/v2/top-headlines?country=${this.country}&apiKey=${this.key}`
            /*const url = 'https://real-time-news-data.p.rapidapi.com/top-headlines?country=US&lang=en'
            const options = {
                  method: 'GET',
                  headers: {
                        'X-RapidAPI-Key': 'f3823d7a20msh0995ce856176df6p13c0d1jsnf62a16cbcc7b',
